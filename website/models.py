...
class User(db.Model, UserMixin):
    ...
    confirmed = db.Column(db.Boolean, nullable=False, default=False)  # tinyint(1) → Boolean
    is_admin = db.Column(db.Boolean, nullable=True, default=False)    # tinyint(1) → Boolean
